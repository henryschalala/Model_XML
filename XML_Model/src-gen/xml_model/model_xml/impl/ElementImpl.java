...
public class ElementImpl extends NodeImpl implements Element {
	...
	protected EClass eStaticClass() {
		return Model_xmlPackage.Literals.ELEMENT;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model_xmlPackage.ELEMENT__VALUE, oldValue, value));
	}
	...
	public EList<Node> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<Node>(Node.class, this, Model_xmlPackage.ELEMENT__CHILDREN);
		}
		return children;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Model_xmlPackage.ELEMENT__VALUE:
			return getValue();
		case Model_xmlPackage.ELEMENT__CHILDREN:
			return getChildren();
		case Model_xmlPackage.ELEMENT__ATTRIBUTES:
